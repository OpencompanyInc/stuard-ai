        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <main className="flex-1 space-y-6">
            <div>
              ...
              <p className="text-gray-600">Manage how you receive updates and alerts from Stuard.</p>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                    ...
                    <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                      <div className="flex items-start gap-3">
                        ...
                        <label htmlFor="sms-consent" className="text-sm text-gray-600 leading-relaxed">
                          ...
                          Review our <Link href="/terms" className="text-primary hover:underline font-medium">Terms</Link> and <Link href="/privacy" className="text-primary hover:underline font-medium">Privacy Policy</Link>.
                  ...
                  <div className="bg-green-50 border border-green-100 rounded-xl p-6">
                    <div className="flex items-start justify-between">
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900">SMS Notifications Active</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Alerts are being sent to <span className="font-medium text-gray-900">{phoneNumber}</span>
                          </p>
                ...
                {error && (
                  <div className="mt-4 p-3 bg-red-50 text-red-700 text-sm rounded-lg border border-red-200 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between py-2 border-t border-gray-100">
                  <div>
                    <h4 className="font-medium text-gray-900">Workflow Summaries</h4>
                    <p className="text-sm text-gray-500">Weekly digest of your agent&apos;s activity.</p>
                  </div>
                  <div className="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
