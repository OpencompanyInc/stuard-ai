...
export const metadata: Metadata = {
  title: 'Download',
  description: 'Download Stuard AI for Windows. Join the waitlist for early access to the local-first desktop assistant.',
  openGraph: {
    title: 'Download - Stuard AI',
    description: 'Download Stuard AI for Windows. Join the waitlist for early access.',
      ...
      <section className="pt-32 pb-16">
        <Container className="text-center">
          ...
          <p className="text-xl lg:text-2xl mb-8 text-gray-600 max-w-3xl mx-auto">
            Automation‑first desktop assistant for Windows — plans you can see, actions on your device, and memory that compounds. Join the waitlist for early access.
          </p>
        </Container>
      </section>
        ...
        <Container>
            ...
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-secondary/5 border-2 border-primary/20">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-3">
                  Stuard AI is Coming Soon
                </h2>
                <p className="text-gray-600 mb-6">
                  We&apos;re putting the finishing touches on Stuard AI. Join the waitlist to be notified when we launch and get exclusive early access pricing.
                </p>
                <div className="bg-white rounded-lg p-6 mb-6">
                  <div className="flex items-center justify-center space-x-8 text-center">
                    <div>
                      <div className="text-3xl font-bold text-primary">Coming Soon</div>
                      <div className="text-sm text-gray-600">Q2 2025 Launch</div>
                    </div>
                    <div className="w-px h-12 bg-gray-300"></div>
                    <div>
                      <div className="text-3xl font-bold text-primary">10% OFF</div>
              ...
              <ol className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Get the latest version from the waitlist email</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center font-semibold mr-4">
          ...
          <div className="mt-16 text-center">
            <p className="text-gray-600 mb-4">
              Don&apos;t miss out on early access pricing
            </p>
            <Link
              href="/#waitlist"
