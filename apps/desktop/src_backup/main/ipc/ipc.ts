...
import { getLocalWebhookPort, workflows_list, workflows_read, workflows_save, workflows_delete, workflows_run, workflows_stop, workflows_deploy, workflows_undeploy, workflows_getDeployStatus, workflowToStuardSpec, WorkflowDefinition } from "../workflows";
...
export function setupIpc() {
  ...
  ipcMain.handle("system:openWorkflows", () => openWorkflowsWindow());
