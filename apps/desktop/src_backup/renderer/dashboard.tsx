        ...
        <div className="w-[280px] border-r border-theme-sidebar bg-theme-sidebar/80 backdrop-blur-2xl flex flex-col z-20 transition-all duration-300">
          ...
          <div className="px-8 pb-10 flex items-center gap-4 select-none">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-theme-muted font-bold uppercase tracking-[0.15em] mt-1 opacity-60">HQ Workspace</div>
            </div>
          </div>
                      ...
                      <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 h-full">
                        ...
                        <div className="flex items-center justify-between mb-8">
                          <div className="space-y-1">
                            ...
                            <p className="text-xs text-theme-muted font-bold uppercase tracking-[0.2em] opacity-50">
                              Adaptive Neural Workspace
                            </p>
                          </div>
