...
import { Play, Square, Save, Code, Settings, Wand2, Rocket, Zap, Terminal, Command, Layout, Plus, ZoomIn, ZoomOut, Maximize2, ChevronDown, Lock, Undo2, Redo2, Copy, Trash2, LayoutGrid } from "lucide-react";

// Icons used in the main app
const Icons = { Play, Stop: Square, Save, Code, Settings, Wand: Wand2, Rocket, Zap, Terminal, Command, Layout, Plus, Lock, Undo: Undo2, Redo: Redo2, Copy, Trash: Trash2, LayoutGrid, Maximize2, ZoomIn, ZoomOut };
              ...
              <>
                {model?.locked ? (
                  <div className="px-3 py-2 text-xs text-slate-400 flex items-center gap-2">
                    <Icons.Lock className="w-3.5 h-3.5" />
                    <span>This workflow is locked</span>
                  </div>
                ) : (
                  <>
                    <button
