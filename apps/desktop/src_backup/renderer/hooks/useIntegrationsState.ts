...
export function useIntegrationsState({ session, AGENT_HTTP, CLOUD_AI_HTTP }: UseIntegrationsStateArgs) {
  ...
  const integrationLibrary = useMemo(
    () => [
      ...
      { slug: "slack", name: "Slack", description: "Send messages and notifications.", category: "Communication", homepage: "https://slack.com/", available: false },
      { slug: "github", name: "GitHub", description: "Read repos and issues.", category: "Development", homepage: "https://github.com/", available: true },
      { slug: "cursor", name: "Cursor", description: "AI code editor integration.", category: "Development", homepage: "https://cursor.com/", available: false },
      ...
      { slug: "jira", name: "Jira", description: "Track tasks and issues.", category: "Development", homepage: "https://www.atlassian.com/software/jira", available: false },
      { slug: "dropbox", name: "Dropbox", description: "Sync and manage files.", category: "Files", homepage: "https://www.dropbox.com/", available: false },
      ...
      { slug: "supabase", name: "Supabase", description: "Connect to your Supabase project.", category: "Data", homepage: "https://supabase.com/", available: false },
