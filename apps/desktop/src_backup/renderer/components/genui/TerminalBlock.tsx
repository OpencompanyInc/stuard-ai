      ...
      <AnimatePresence initial={false}>
        {(output || running) && isExpanded && (
          ...
          >
            <pre 
              ref={outputRef}
              className="px-4 py-3 text-xs text-neutral-400 font-mono whitespace-pre-wrap max-h-[300px] overflow-y-auto custom-scrollbar leading-relaxed selection:bg-neutral-700 selection:text-white"
            >
              {output}
              {running && (
