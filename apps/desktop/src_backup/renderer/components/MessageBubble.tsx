...
import { ChevronRight, Folder, FileText, Play, ExternalLink, CheckCircle, XCircle, Loader2, Copy, Check } from 'lucide-react';
              ...
              if (chunk.type === 'tool') {
                ...
                return (
                  <div
                    key={`t-${idx}`}
                    className={clsx(
                      "flex items-center gap-2 px-3 py-1.5 rounded-full text-[11px] font-black uppercase tracking-widest w-fit shadow-sm border transition-all",
                      tc.status === 'completed'
