...
export function Pinboard({ entities, links, onSelectEntity, selectedEntity }: PinboardProps) {
  ...
  return (
    <div ref={ref} className="w-full h-full relative overflow-hidden bg-[#2c2c2e]" 
      ...
      {/* Legend */}
      <div className="absolute bottom-6 right-6 p-4 bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl transition-all hover:scale-105">
        <div className="font-bold text-white border-b border-white/10 pb-2 mb-3 text-[10px] tracking-[0.2em] uppercase text-center font-stuard opacity-80">
            Memory Map
        </div>
        
        <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-[10px] text-white/70 font-bold">
            <div className="flex items-center gap-2.5">
                <span className="w-3.5 h-3.5 rounded-sm bg-[#fef9c3] shadow-inner"></span> 
                Projects
            </div>
            <div className="flex items-center gap-2.5">
                <span className="w-3.5 h-3.5 rounded-sm bg-[#ffe4e6] shadow-inner"></span> 
                People
            </div>
            <div className="flex items-center gap-2.5">
                <span className="w-3.5 h-3.5 rounded-sm bg-[#dbeafe] shadow-inner"></span> 
                Companies
            </div>
            <div className="flex items-center gap-2.5">
                <span className="w-3.5 h-3.5 rounded-sm bg-[#dcfce7] shadow-inner"></span> 
                Tools
            </div>
            <div className="flex items-center gap-2.5 col-span-2 mt-1 py-1 px-2 bg-white/5 rounded-lg border border-white/10">
                <span className="w-3.5 h-3.5 rounded-sm bg-[#1a1a1a] border-2 border-[#ef4444]"></span> 
                <span className="text-white">Topic / Group Titles</span>
            </div>
        </div>
        
        <div className="mt-4 pt-2 border-t border-white/5 text-[9px] text-white/40 font-bold text-center tracking-wider">
