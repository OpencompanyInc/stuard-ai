...
const PresetButton = ({ label, active, onClick }: { label: string, active: boolean, onClick: () => void }) => (
  <button
    onClick={onClick}
    className={`px-3 py-1.5 rounded-theme-button text-[12px] font-bold transition-all border shadow-sm ${
      active 
...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto pb-16">
      ...
      <div className="bg-theme-card rounded-theme-card border border-theme p-6 shadow-sm mb-6">
        <SectionHeader title="Voice" description="Configure voice activation and input." />
