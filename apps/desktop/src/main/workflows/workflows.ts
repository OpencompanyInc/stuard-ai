...
import { designerModelToStuardSpec as coreDesignerModelToStuardSpec } from "@stuardai/workflow-core/runtime";
...
// Implementation is shared with the VM engine via @stuardai/workflow-core/runtime.
// Desktop routes by tool name (no normalizeKind) and keeps the model's autostart.
export function designerModelToStuardSpec(m: any, triggerId?: string): StuardSpec {
  return coreDesignerModelToStuardSpec(m, { triggerId }) as StuardSpec;
}
