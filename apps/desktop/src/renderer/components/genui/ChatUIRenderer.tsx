  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        setAssets({ reactUmd: assetRes.reactUmd, reactDomUmd: assetRes.reactDomUmd, framerMotionUmd: assetRes.framerMotionUmd || '', tailwindCss: assetRes.tailwindCss, extraCss: assetRes.extraCss, jitJs: assetRes.jitJs || '' });
