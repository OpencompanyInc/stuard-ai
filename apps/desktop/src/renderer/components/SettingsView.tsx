...
import { RefreshCw, Download, ArrowUpCircle, CheckCircle, AlertCircle, Loader2, FlaskConical, Beaker, RotateCcw, X, Sparkles, Cloud, CloudOff, Shield, Lock, Eye, EyeOff, Key, Archive } from "lucide-react";
...
function SecurityPrivacySection() {
  ...
  const handleToggle = async (key: 'vault_lock_enabled' | 'memory_lock_enabled', value: boolean) => {
    // Must have a password set first
