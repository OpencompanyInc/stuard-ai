...
export const TOOL_GROUP_LABELS: Record<string, { singular: string; plural: string }> = {
  ...
  research_search: { singular: 'Searched sources', plural: 'Ran {n} research searches' },
  research_read: { singular: 'Read source', plural: 'Read {n} sources' },
  research_note: { singular: 'Distilled notes', plural: 'Distilled notes ×{n}' },
  research_status: { singular: 'Reviewed research', plural: 'Reviewed research ×{n}' },
