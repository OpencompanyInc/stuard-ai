      ...
      >
        {tabs.map(tab => (
          <div
            ...
            className={clsx(
              "group flex items-center gap-2 px-3 py-1.5 rounded-xl text-[13px] font-medium transition-all duration-200 cursor-pointer select-none min-w-[120px] max-w-[200px] flex-shrink-0 relative",
              tab.id === activeTabId
