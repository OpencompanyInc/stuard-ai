  ...
  return (
    <div
      className={clsx(
        ...
        'border-b border-theme-sidebar bg-theme-card/60 backdrop-blur-sm',
...
const ProjectSwitcherDropdown: React.FC<ProjectSwitcherDropdownProps> = ({
  ...
  return createPortal(
    <div
      ref={containerRef}
      className="fixed z-[1000] w-[260px] max-h-[280px] overflow-y-auto custom-scrollbar rounded-xl bg-theme-card border border-theme shadow-xl py-1"
