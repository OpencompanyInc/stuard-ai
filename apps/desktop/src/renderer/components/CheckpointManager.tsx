...
export const CheckpointManager: React.FC<CheckpointManagerProps> = ({ onRevert, className }) => {
  ...
  return (
    ...
    >
        ...
        <button
          className={clsx(
            ...
            hasCheckpoints
              ...
              : "bg-theme-hover/60 hover:bg-theme-hover text-theme-muted",
            className
          )}
      ...
      <Popover.Portal>
        <Popover.Content
          className="z-[10003] w-[340px] bg-theme-card rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150"
          sideOffset={8}
          align="end"
          side="top"
          collisionPadding={10}
        >
          ...
          <AnimatePresence>
            {feedback && (
              ...
              >
                <div className={clsx(
                  "mx-3 mt-3 p-2.5 rounded-xl flex items-center gap-2",
                        ...
                        return (
                          <div
                            ...
                            className={clsx(
                              ...
                              isConfirming
                                ? "bg-destructive/5"
                                : "bg-theme-hover/20 hover:bg-theme-hover/40"
                            )}
                          >
                            {isConfirming ? (
                              <motion.div
                                  ...
                                  <div className="flex items-center gap-1 shrink-0">
                                    {cp.canRedo ? (
                                      <button
                                        ...
                                        disabled={!!redoing}
                                        className="flex items-center gap-1 px-2 py-1.5 bg-blue-500/10 hover:bg-blue-500/20 rounded-lg text-[11px] font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-all disabled:opacity-50"
                                      ...
                                      <button
                                        ...
                                        className="flex items-center gap-1 px-2 py-1.5 bg-theme-hover/50 hover:bg-theme-hover rounded-lg text-[11px] font-semibold text-theme-muted hover:text-theme-fg transition-all"
