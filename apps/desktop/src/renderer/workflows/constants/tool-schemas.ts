...
const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  // --- UI ---
  { id: 'custom_ui', category: 'ui', kind: 'local', description: 'Show a custom desktop UI built with React JSX. Best for forms, overlays, live status panels, and mini-app flows. Supports Tailwind, Framer Motion, workflow data via useVar(), and Stuard APIs like submit, callTool, and callNode.', argsTemplate: { id: 'my-panel', title: 'My Custom UI', component: '', css: '', data: {}, window: { width: 400, height: 500, position: 'center', alwaysOnTop: false, frameless: true, borderRadius: 12, resizable: false, draggable: true, minimizable: true, backgroundType: 'color', backgroundColor: '#1a1a2e', contentPadding: 24, shadow: { enabled: true, color: '#00000040', blur: 20, spread: 0, x: 0, y: 8 }, animation: { open: 'fade', close: 'fade', duration: 300, easing: 'ease-out' }, invisible: false, translucent: { color: '#1a1a2e', opacity: 0.7, blur: 12 } }, blocking: true }, outputSchema: { ok: 'boolean', action: 'string', data: 'object' } },
