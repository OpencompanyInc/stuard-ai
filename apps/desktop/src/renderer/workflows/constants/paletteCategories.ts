...
label: 'ElevenLabs Voice',
    ...
    items: [
      ...
      { k: 'cloud.tool', t: 'elevenlabs_twilio_outbound_call', label: 'Start Live Agent Call', icon: PhoneCall, args: { agent_id: '', agent_phone_number_id: '', to_number: '', conversation_initiation_client_data: {} } },
    ],
  },
  {
    id: 'files',
