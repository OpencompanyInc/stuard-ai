...
const RAW_ALL_TOOLS = {
  ...
  agent_todo,
  // Agent management from normal chat (@tag status, create, deploy)
  agent_list,
  agent_get_status,
  agent_create,
  agent_deploy,
  ...
  ask_agent,
  agent_ask,
  // Legacy bot aliases kept for compatibility
  bot_list,
  bot_get_status,
  bot_create,
  bot_deploy,
