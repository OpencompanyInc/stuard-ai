...
export type SubagentKind = 'browser' | 'file_ops' | 'cli_agent' | 'workflow' | 'reminders' | 'ffmpeg' | 'data_analysis' | 'media' | 'vm' | 'bot' | 'agent' | 'integration' | 'integration_builder' | 'skills' | 'custom';
